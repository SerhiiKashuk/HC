...
import status.ServerConnectionRecord;
 ...
 * 
 */
public class HChannelTrafficShapingHandler extends 
    ...
    public HChannelTrafficShapingHandler(long checkInterval) {
	super(checkInterval);
    }
